...
def high():
    if args.cushion > 0.0:
        ...
        logging.info("sensor_pub high active time {} {}".format(sensor.active_time, args.cushion))
...
def low():
    if args.cushion > 0.0:
        time.sleep(args.cushion)
        logging.info("sensor_pub low active time {} {}".format(sensor.active_time, args.cushion))
